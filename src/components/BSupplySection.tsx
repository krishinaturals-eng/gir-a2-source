      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-center mb-4 sm:mb-6">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-foreground mb-3 sm:mb-4 md:mb-6">Bulk Order Specifications</h3>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <Card className="p-3 sm:p-4 text-center">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-foreground mb-1 sm:mb-2">Minimum Order</h4>
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-earth-green mb-1">100 kg</p>
              <p className="text-xs sm:text-sm text-muted-foreground">Starting MOQ</p>
            </Card>
            ...
            <Card className="p-3 sm:p-4 text-center">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-foreground mb-1 sm:mb-2">Packaging</h4>
              <p className="text-sm sm:text-base text-foreground mb-1">15 KG tins (16.5L)</p>
              <p className="text-xs sm:text-sm text-muted-foreground">500ml & 1L jars</p>
            </Card>
            ...
            <Card className="p-3 sm:p-4 text-center">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-foreground mb-1 sm:mb-2">Monthly Supply</h4>
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-golden-accent mb-1">5 tonnes</p>
              <p className="text-xs sm:text-sm text-muted-foreground">Capacity/month</p>
            </Card>
            ...
            <Card className="p-3 sm:p-4 text-center">
              ...
              <h4 className="text-base sm:text-lg font-semibold text-foreground mb-1 sm:mb-2">Pricing</h4>
              <p className="text-sm sm:text-base text-foreground mb-1">Competitive rates</p>
              <p className="text-xs sm:text-sm text-muted-foreground">Volume discounts</p>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            <Card className="p-6 sm:p-8">
              <h4 className="text-lg sm:text-xl md:text-2xl font-semibold text-foreground mb-4 sm:mb-6">Packaging Formats</h4>
            ...
            <Card className="p-6 sm:p-8 bg-earth-green/5">
              <h4 className="text-lg sm:text-xl md:text-2xl font-semibold text-earth-green mb-4 sm:mb-6">Pricing Benefits</h4>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-earth-green rounded-full mt-2"></div>
                  <div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-earth-green/10 to-trust-blue/10 rounded-2xl p-6 mb-6">
            <h4 className="text-lg sm:text-xl md:text-2xl font-semibold text-foreground mb-2 sm:mb-3">🚀 Limited Time Offer</h4>
            <p className="text-sm sm:text-base md:text-lg text-muted-foreground mb-4 sm:mb-6">
              Get 5% discount on orders above 500kg this month
            </p>
            <div className="flex justify-center items-center space-x-4 sm:space-x-6 text-sm sm:text-base">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-earth-green">24</div>
                <div className="text-muted-foreground">Hours</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-earth-green">500kg</div>
                <div className="text-muted-foreground">Min Order</div>
              </div>
              <div className="text-center">
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-earth-green">5%</div>
