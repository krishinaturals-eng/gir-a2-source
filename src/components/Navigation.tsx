...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-background/98 backdrop-blur-md border-b border-border z-[60] shadow-sm">
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-background border-t border-border">
              {navItems.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-foreground hover:text-earth-green block px-4 py-3 text-base font-medium transition-colors duration-200"
